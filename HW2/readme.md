...
## **A2:** вижу, так как Т1, в рамках которой добавлялась новая запись, была "закомичена", после этого запись стала доступна в Т2, которой установлен уровнем изоляции read committed
...
## **A5:** вижу. Потому что запрос выполняется в Т3. А запись была обавлена в Т1, завершившейся до открытия Т3. 
